...
export const standardAnswers = [
  [
    ...
    ["bad", "sad"],
    ["thank you"],
    ["have a nice day", "bye", "take care yourself", "good bye"],
  ],
  [
    [
      "I am fine. Thank you for asking. What about you?",
...
export const possibleAnswers = [
  ...coffees.map((i) => i.name),
  ...sizes.map((i) => i.name),
  ...lists,
  ...counts,
  ...requests,
  ...hellos,
  ...standardAnswers[0].join(",").split(","),
];

export { NODE_ENV, connections };
